...
for kndx in range(30):
    ...
    gt = GarbageTruck(0, simulation_time, "garbage_truck", 'sname', GARBAGETRUCK_SIZE, [e for e in enumerate([TRUCK_DELAY for building in blist])],outputlocation, int(sys.argv[2]))#4.7*13*3
