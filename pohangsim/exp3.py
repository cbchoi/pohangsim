...
gt = GarbageTruck(0, simulation_time, "garbage_truck", 'sname', 4.7*13*3, [e for e in enumerate([0.1 for building in blist])],"bluecollar_N98")
...
for building in blist:
    ...
    g = GarbageCan(0, simulation_time, "gc[{0}]".format(i), 'sname', 55,"bluecollar_N98")
