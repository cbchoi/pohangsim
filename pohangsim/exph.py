...
gt = GarbageTruck(0, simulation_time, "garbage_truck", 'sname', 68, [e for e in enumerate([0.1 for building in blist])],"7am_only_h0.4")#4.7*13*3
...
for building in blist:
    ...
    g = GarbageCan(0, simulation_time, "gc[{0}]".format(i), 'sname', 55,"7am_only_h0.4")
